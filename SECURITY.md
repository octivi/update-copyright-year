...
If [GitHub Security Advisories](https://github.com/octivi/update-copyright-year/security/advisories)
are not available, [open a new issue](https://github.com/octivi/update-copyright-year/issues/new)
